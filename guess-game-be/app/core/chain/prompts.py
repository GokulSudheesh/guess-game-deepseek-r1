...
user_answer_mapper: dict[AnswerEnum, str] = {AnswerEnum.YES: "yes", AnswerEnum.NO: "no", AnswerEnum.MAYBE: "maybe",
                                             AnswerEnum.DONT_THINK_SO: "dont think so", AnswerEnum.DONT_KNOW: "dont know"}
